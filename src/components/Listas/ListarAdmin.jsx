    ...
    return (
        ...
        >
            <Paper sx={{
                ...
                < Typography textAlign="center" variant="h6" gutterBottom>Lista de datos Admins</Typography>
                <List>
                    {datos.map((item) => (
                        <ListItem
                            key={item.id}
                            ...
                            <ListItemText
                                secondary={
                                    <>
                                        ...
                                        <span>
                                            <Link to={`/detalleadmin/${encodeURIComponent(item.id)}`} style={{ textDecoration: "none", color: "#1976d2" }}>
                                                Ver detalle
                                            </Link>
                                        </span>
                                    </>
