    ...
    <div className="dashboard-container">
      ...
      <div className="dashboard-botones">
        <div className="altas">
          ...
          <button onClick={() => navigate("/altatutor")} className="boton-dashboard">Alta Tutores</button>
        </div>
        <div className="listar">
          ...
          <button onClick={() => navigate("/listartutor")} className="boton-dashboard">Listar Tutores y ver detalle</button>
        </div>
      </div>
      <button
