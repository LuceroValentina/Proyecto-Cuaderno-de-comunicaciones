...
import "../css/FormCaliTrabajosPracticos.css";
import "../css/Elementos.css";

const FormCaliTrabajosPracticos = ({ titulo = "Formulario Calificacion Trabajos Practicos" }) => {
...
export default FormCaliTrabajosPracticos;